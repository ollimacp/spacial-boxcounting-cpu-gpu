...
parser.add_argument("--verbosity", type=int, default=False, help="Set verbosity True/False for display results, or show additional data for debugging")
...
class CNN_BC_enc():
    ...
    def __init__(self,opt, ChunkLenght,ModelnameList ):
